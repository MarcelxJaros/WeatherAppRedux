  ...
  return (
    ...
    <div className='home-container'>
      <div className="hero-container">
        ...
        <Typography variant="h1" component="div">SkyDiff</Typography>
      </div>
      ...
      <Typography variant="body1" sx={{ textAlign: 'justify' }}>
        ...
        I also have a creative side and a good sense of visual design, which I believe adds value to my work. I genuinely enjoy collaborating with others and being a part of a team. I believe that being a team player is important for producing great results and I'm always open to learning from my colleagues.<br />  
        My LinkedIn profile with contact info: <br className='line-break-phone' />
        <span className="author-click" onClick={() => {window.open('https://www.linkedin.com/in/marcel-jaros/', '_blank')}}>
